...
{
    public partial class RptPartyReceivable : Form
    {
        DAL.Reports objDAL = new DAL.Reports();

        public RptPartyReceivable()
        {
            InitializeComponent();
        }
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            ...
            {                                
                ...
                DataTable dt = objDAL.getPartiesRecPay( vDateTo.ToShortDateString(), true);
                if (dt.Rows.Count == 0)
                {
                    MessageBox.Show("No Data To Display", "No Data");
                    return;
                }
                vForm.ShowRecPay(vDateTo, true, dt);
                vForm.ShowDialog();
            }
            catch (Exception exc)
            {
        ...
        private void RptPartyReceivable_Load(object sender, EventArgs e)
        {
