...
{
    public partial class RptPartySampleIssue : Form
    {
        DAL.StockSamples objDAL = new DAL.StockSamples();
        public RptPartySampleIssue()
        {
            InitializeComponent();
        }
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Reports.RptReportViewer vForm = new Reports.RptReportViewer();
                    ...
                    {
                        vWhere += " AND StockSamples.CustomerID=" + this.txtVendorID.Text;
                    }
                    ...
                    {
                        vWhere += " AND StockSampleBody.ProductID=" + this.txt_ProductID.Text;
                    }

                    if (optRange.Checked == true)
                    {
                        vWhere += " AND convert(datetime,Convert(varchar,StockSamples.IssueDate,1)) Between Convert(Datetime,(convert(varchar,convert(Datetime,'" + this.dt_From.Text + " 00:00:00',102),1))) AND Convert(Datetime,(convert(varchar,convert(Datetime,'" + this.dt_ToDate.Text + " 00:00:00',102),1)))";
                    ...
                    vForm.PartyStockSample(criteria, dt);
                    vForm.ShowDialog();
