...
{
    public partial class RptPartyLedger : Form
    {
        DAL.Reports objDAL = new DAL.Reports();

        public RptPartyLedger()
        {
            InitializeComponent();
        }
        ...
        private void btnPreview_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                vForm.ShowPartyLedger(vPartyID, string.Empty, vDateFrom, vDateTo, dt,chkLetterPad.Checked);
                vForm.ShowDialog();
            }
            catch (Exception exc)
            {
        ...
        private void txtVendorID_TextChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                vWhere = "AND AccountChart.IsParty = 1 AND AccountChart.AccountNo = " + txtVendorID.Text;
