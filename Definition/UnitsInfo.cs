...
{
    public partial class UnitsInfo : Form
    {
        DAL.UnitsInfo objDAL = new DAL.UnitsInfo();
        ...
        private void LoadGrid()
        {
            try
            {
                ...
                {
                    vWhere = " AND UnitTitle Like '%" + txtFilter.Text + "%'";
                }
        ...
        private void Grid_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    txtID.Text = Grid.Rows[Grid.CurrentRow.Index].Cells["UnitID"].Value.ToString();


                    DataTable dt = objDAL.getRecord(" AND UnitID=" + txtID.Text);
                    txtName.Text = dt.Rows[0]["UnitTitle"].ToString();                                                           
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Objects.UnitsInfo obj = new Objects.UnitsInfo();
                obj.UnitID = Int32.Parse(txtID.Text);
                obj.UnitTitle = txtName.Text.Trim();                
                

                if (!vOpenMode)
                {
                    //Insert 
                    obj.UnitID = objDAL.getNextNo();
        ...
        private void UnitsInfo_KeyDown(object sender, KeyEventArgs e)
        {
