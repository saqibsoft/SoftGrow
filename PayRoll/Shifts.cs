...
namespace SoftGrow.PayRoll
{
    ...
    {
        DAL.Shifts objDAL = new DAL.Shifts();
        ...
        private void LoadGrid()
        {
            try
            {
                ...
                {
                    vWhere = " AND ShiftTitle Like '%" + txtFilter.Text + "%'";
                }
        ...
        private void Grid_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    txtID.Text = Grid.Rows[Grid.CurrentRow.Index].Cells["ShiftID"].Value.ToString();


                    DataTable dt = objDAL.getRecord(" AND ShiftID=" + txtID.Text);
                    txtName.Text = dt.Rows[0]["ShiftTitle"].ToString();                                                           
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Objects.Shifts obj = new Objects.Shifts();
                obj.ShiftID = Int32.Parse(txtID.Text);
                obj.ShiftTitle = txtName.Text.Trim();                
        ...
        private void Shifts_KeyDown(object sender, KeyEventArgs e)
        {
