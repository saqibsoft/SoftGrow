    ...
    public partial class Designation : Form
    {
        ...
        private void Grid_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    txtID.Text = Grid.Rows[Grid.CurrentRow.Index].Cells["DesignationID"].Value.ToString();


                    DataTable dt = objDAL.getRecord(" AND DesignationID=" + txtID.Text);
                    txtName.Text = dt.Rows[0]["DesignationTitle"].ToString();                                                           
