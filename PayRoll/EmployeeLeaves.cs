...
namespace SoftGrow.PayRoll
{
    ...
    {
        DAL.EmployeeLeaves objDAL = new DAL.EmployeeLeaves();
        MyMessages Message = new MyMessages();
        bool vOpenMode = false;
        int vUserID;
        public EmployeeLeaves(int userid)
        {
            InitializeComponent();
            vUserID = userid;
        }
        ...
        private void EmployeeLeaves_KeyDown(object sender, KeyEventArgs e)
        {
