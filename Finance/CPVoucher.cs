    ...
    public partial class CPVoucher : Form
    {
        ...
        private void PrintVoucher()
        {
            ...
            else if (vVoucherType == "CPV")
            {
                ...
                dt.AsEnumerable().Sum(r => r.Field<Decimal>("Debit"));

                dr["Credit"] = vTotalAmount.ToString("G29"); //dt.Rows[0]["Debit"];
        ...
        private void CPVoucher_KeyDown(object sender, KeyEventArgs e)
        {
