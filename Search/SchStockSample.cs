...
{
    public partial class SchStockSample : Form
    {
        public SchStockSample()
        {
            InitializeComponent();
        }
        ...
        {            
                ...
                {
                    MyID = Grid.Rows[Grid.CurrentRow.Index].Cells["SampleID"].Value.ToString();
                }
                Close();
        }
        ...
        private void DisplayData()
        {
            ...
            vWhere += string.Format(" And convert(datetime,Convert(varchar,StockSamples.IssueDate,1)) Between Convert(Datetime,(convert(varchar,convert(Datetime,'{0} 00:00:00',102),1)))and Convert(Datetime,(convert(varchar,convert(Datetime,'{1} 00:00:00',102),1)))", dt_From.Value.ToShortDateString(), dt_ToDate.Value.ToShortDateString());
