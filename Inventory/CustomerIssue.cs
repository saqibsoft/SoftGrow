...
namespace SoftGrow.Inventory
{
    public partial class CustomerIssue : Form
    {
        ...
        public CustomerIssue(int UserID)
        {
            InitializeComponent();
            vUserID = UserID;
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                Objects.CustomerIssue BAL = new Objects.CustomerIssue();

                BAL.IssueID = Int64.Parse(txtInvNo.Text);
                BAL.IssueDate = dtEntryDate.Value;
                BAL.CustomerID = int.Parse(txtCustomerID.Text);
                BAL.SecurityDeposit = vSecurity;                
                ...
                else
                {
                    ...
                    BAL.IssueID =Int64.Parse(dt.Rows[0]["IssueID"].ToString());
                }
                ...
                foreach (DataGridViewRow dr in Grid.Rows)
                {
                    if (dr.Cells[0].Value != null)
                    {
                        Objects.CustomerIssueBody objBody = new Objects.CustomerIssueBody();
                        objBody.IssueID = BAL.IssueID;
        ...
        {
            SearchForms.SchStockIssue vForm = new SearchForms.SchStockIssue();
            vForm.ShowDialog();
        ...
        private void CustomerIssue_KeyDown(object sender, KeyEventArgs e)
        {
